...
## Chapter 1
### Title
The Same Red Morning

### Content
The alarm drags you from sleep at 04:07, same as every loop before. Third ring. Copper floods the back of your throat—the taste of time folding over itself. Varda Station's emergency lights cycle red across the ceiling of your cramped quarters, painting the walls in pulses that match your hammering heart.

Your jumpsuit hangs over the chair in the same arc. The half-eaten ration bar sits on the shelf, two bites from the end. You stopped counting loops when the number lost meaning. What you haven't stopped counting is deaths: seventeen people, every time, when the Fracture cluster punches through the observation deck at 06:47.

The Fracture—angular shapes, dark and fast, something the survey logs can't classify—has breached this station on this exact morning more times than you can bear to remember. The first loop, you died in the hull rupture yourself, thrashing in a suit whose seal had already melted. Now you wake here instead, carrying every failed attempt like scar tissue layered over scar tissue.

Somewhere three decks below, an alien artifact hums in its magnetic cradle in the sealed lower vault. Dara Osei, the station's lead signal analyst, has been getting closer to reading its output, loop by loop. Commander Voss in ops still doesn't believe a word you've told him. The Fracture arrives in two hours and forty minutes. You swing your legs off the bunk.

### Choices
1. Go to Commander Voss in ops and force him to listen -> 2
2. Find Dara in engineering—she's close to cracking the artifact's signal -> 3
...
In the lower corridors, the ring C construction crews are finishing a hull repair. Their cutting tools and rivet guns are heavy enough to serve as weapons. You've inventoried those lockers in past loops.
...
### Content
You find Dara Osei in engineering, surrounded by empty ration packs and two mugs of coffee she's forgotten to drink. Lead signal analyst, three tours on deep-belt stations, the only person on Varda who took the artifact seriously from the start. Tonight she's been here since second shift ended: smudges under her eyes, hair tied back with cable from the equipment rack, muttering to herself as she works through sensor data from the sealed vault.

This loop is different. Usually she's bent over the screens when you arrive. This time she looks up before you speak, as if the data itself has been waiting for exactly this interruption.
...
At 06:47:21 the proximity alarm screams. Voss stares at you across the ops table with every trace of skepticism stripped from his face. The perimeter array lights up at the exact bearing, the exact declination. Outside the reinforced viewport, the dark moves—angular shapes sliding across the starfield in tight formation.
...
2. Run for the emergency pods before structural failure makes escape impossible -> 9
...
Six weeks later, Varda Station files its incident report under a corporate charter that classifies the artifact, the loop, and the Fracture for thirty years. Dara's name appears in none of the public filings. The people she saved will sleep tonight not knowing it. The loop is over. The price was real, and you will carry it exactly as long as you live.
...
### Content
You sprint hard for ring two, legs burning, the station groaning around you in registers you've never heard before. Not the sharp crack of a Fracture breach against the outer pane—something structural, something coming apart at a level below the deck plates themselves. The umbilical locks to the emergency pod bay are dead when you arrive, sheared by a cascade failure two sections aft. The indicator panel flickers red across every berth: launch disabled, docking clamps frozen.

You stand at the sealed hatch and notice the absence.

No copper taste at the back of your throat. Every loop—every reset, every death, fast or slow or in a suit that wouldn't seal—the copper arrived first. A signal from the boundary between this moment and the next, pulling at your consciousness like a tide drawing back before it turns. It's not here. The artifact, burning somewhere below in a cascade the station can no longer contain, has spent its last pulse. The anchor is gone.

This is not a reset. There is no next loop. There is only the station's last sound—a low harmonic groan that vibrates through the sealed hatch under your palms—and the dark outside the sheared viewport where the stars sit motionless and indifferent.

Varda Station is gone. You had more loops than anyone deserved, and it wasn't enough.
...
### Content
Dara Osei cuts the power coupling in one precise movement while you brace the magnetic cradle with both hands against the artifact's resistance. The hum against your sternum—your constant companion through every version of this day—drops in pitch, stutters twice, and goes still. The resonance on her screen flattens to a line. Silence fills the vault like water rising.

Outside, the Fracture cluster completes its final approach and disperses. Without the beacon, there's nothing to home on. One by one the angular shapes separate into the dark with the unhurried drift of things that have somewhere else to be.

Varda Station runs damage assessments on a breach that never came. Commander Voss files a proximity alert and closes it within the hour. Seventeen people who died in every previous version of this morning eat breakfast and argue about the duty roster and notice nothing unusual about the day.

Dara looks at you. "You okay? You look like you've been awake for a week."
